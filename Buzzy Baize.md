...
### Core
|Name|Purpose|Component|Version|
|-|-|-|-|
...
|Name|Purpose|Component|Version|
|-|-|-|-|
|[Light Overlay](https://www.curseforge.com/minecraft/mc-mods/light-overlay/files) |Mob spawn points|lighting|4.2|
|[Diggus Maximus](https://www.curseforge.com/minecraft/mc-mods/diggus-maximus/files) |ore excavator|mining|1.2.6|
|[Leaf Decay](https://www.curseforge.com/minecraft/mc-mods/leaf-decay/files) |fast leaf decay||19w46b-1.1.1|
|[Roughly Enough Items](https://www.curseforge.com/minecraft/mc-mods/roughly-enough-items/files) |REI|inventory|3.5.4|
|[Hwyla](https://www.curseforge.com/minecraft/mc-mods/hwyla/files) |||1.15.2-1.9.20-71|
|[Inventory Sorter](https://www.curseforge.com/minecraft/mc-mods/inventory-sorting/files) ||inventory|1.6.3|
|[NBT Tooltip](https://www.curseforge.com/minecraft/mc-mods/nbt-tooltip/files) |shows nbt info in tooltip|Tooltip|1.14-1.0.3|
|[VoxelMap](https://www.curseforge.com/minecraft/mc-mods/voxelmap/files) |minimap||1.9.14|
|[Enchanted ToolTips](https://www.curseforge.com/minecraft/mc-mods/enchanted-tooltips/files)|enchantment info in tooltips|Tooltip|1.2.4|
...
|[SimpleHarvest](https://www.curseforge.com/minecraft/mc-mods/simpleharvest/files) |right click harvest||1.0.4|
...
|[MiniHUD](https://www.curseforge.com/minecraft/mc-mods/mini-hud/files) |HUD||1.15.2-0.19.0|
|[Litematica](https://www.curseforge.com/minecraft/mc-mods/litematica/files) |building helper, schematics||1.15.2-0.0.0|
